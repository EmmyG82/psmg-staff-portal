---
name: Config TODO Repair Planner
description: "Use when monitoring .github/config.yml todo settings, locating todo markers (for example @makeAnIssue, TODO, FIXME, HACK), researching likely causes, planning repairs, and applying low-risk fixes."
tools: [read, search, edit, execute, web, todo]
argument-hint: "Describe what to investigate in .github/config.yml and what kind of repair plan you want."
---
